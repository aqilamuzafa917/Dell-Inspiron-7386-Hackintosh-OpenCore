...
* [✓] Booting macOS installer & installed OS
* [✓] Graphics Acceleration (Intel UHD 620)
* [✓] Audio Output/Input (`AppleALC.kext` + Manual Patch if needed)
* [✓] Wi-Fi (`itlwm.kext` + HeliPort app)
* [✓] Bluetooth
* [✓] Keyboard (`VoodooPS2Keyboard.kext`)
* [✓] Trackpad & Gestures (`VoodooI2C.kext` + `VoodooI2CHID.kext`)
* [✓] USB Ports (Mapped via `USBToolBox.kext` + `UTBMap.kext`)
* [✓] Integrated Webcam
* [✓] Battery Status (`SMCBatteryManager.kext`)
* [✓] CPU Power Management (`SSDT-PLUG.aml`)
* [✓] NVMe Storage (`NVMeFix.kext`)
* [✓] Sleep/Wake (Basic sleep; Hibernation disabled via `pmset`)
* [✓] Restart/Shutdown
* [✓] Dual Boot with Windows (via OpenCore picker)

## ❌ What Doesn't Work / Disabled

* [✗] **Fingerprint Reader:** Not supported by macOS. Disabled via `UTBMap.kext`.
* [✗] **Hibernation/Deep Sleep:** Incompatible with Hackintosh. Disabled via `pmset` commands post-install.
...
## 🚀 Installation Steps (Single Drive Dual Boot with Windows Pre-installed)
